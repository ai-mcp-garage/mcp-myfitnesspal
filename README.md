...
git clone https://github.com/ai-mcp-garage/mcp-myfitnesspal.git
cd mcp-myfitnesspal
...
```json
{
  "mcpServers": {
    "myfitnesspal": {
      "command": "/Users/yourname/mcp-myfitnesspal/venv/bin/python",
...
```json
{
  "mcpServers": {
    "myfitnesspal": {
      "command": "C:\\Users\\YourName\\mcp-myfitnesspal\\venv\\Scripts\\python.exe",
      "args": ["-m", "mfp_mcp.server"],
      "env": {
        "MFP_USERNAME": "your_email@example.com",
        "MFP_PASSWORD": "your_password"
